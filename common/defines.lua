...
NDiplomacy = {
	...
	GREAT_PROJECT_WARSCORE_COST_MODIFIER = 0.05,	-- How much each great project multiplies a war score cost by (so 1 GP adds 33%, 2 add 66% etc)
	...
	LACK_OF_ELECTORS_HIT = -0.05,					-- Also applied to vassalized electors
	JOIN_HRE_DEVELOPMENT_CAP_VASSAL = 20000,			-- Max cap of development of vassals to join the empire
	...
	EXCOMMUNICATE_ACTION_MONTHS = 1, 				-- Excommunication "cooldown" (months)
	...
	EMPEROR_REVOKE_AUTHORITY_COST = 25.0,			-- Cost for the emperor to revoke a reform
	EMPEROR_REVOKE_MODIFIER_DAYS = 365,			-- How long the temporary modifier applied after revoking will last
	...
	MIN_PAPAL_INFLUENCE_TO_PREVENT_EXCOMMUNICATION = 150, -- Papal influence that prevents excommunication
	...
	SUPPORT_REBELS_DURATION = 10, -- in years
	...
	PEACE_COST_RETURN_CORE = 0.65,						-- Return a core (scales by province wealth)
	PEACE_COST_REVOKE_CORE = 0.4,						-- Revoke a core (scales by province wealth)
	PEACE_COST_RELEASE_ANNEXED = 0.55,					-- Release annexed nation (scales by province wealth)
	...
	AUTODIPLO_TARGET_COALITION_IMPROVECAP = 90,
...
NCountry = {
	...
	CORRUPTION_COST = 0.00,						-- cost for monthly combat per development
	...
	CULTURAL_UNION_MIN_DEV = 1500,				-- Minimum development to get cultural union effect without Common Sense, or if CULTURAL_UNION_MIN_RANK is set to negative value.
	...
	MIN_DEV_FOR_FREE_CITY = 6,					-- Capital must have at least this much development to be a free city
	...
	MIN_DEVELOPMENT_FOR_GOV_RANK_3 = 1500,		-- Need at least this much development to upgrade to government rank 3
	...
	ADDITIONAL_MIN_DEVELOPMENT_FOR_GOV_RANK_X = 1500,	-- ADDITIONAL development needed to upgrade to government rank above 3
	...
	PLAYER_CAN_MOVE_FIXED_CAPITAL = 0,				-- Controls whether player can move capital even if capital is fixed
	DEVELOPMENT_ON_CONTINENT_FOR_NEW_CAPITAL = 50.0,	-- How many percent of your development needs to be on the other continent to move your capital there
	...
	GREAT_PROJECT_MANPOWER_CONSTRUCTION_BOOST_AMOUNT_IN_DAYS = 900, --how far throwing men at the problem gets you
	...
	TECH_TIME_COST = 0.5,			-- tech grow with 20% cost over time.
	...
	PS_REDUCE_INFLATION = 500,
	PS_PROMOTE_MERCANTILISM = 100,
	PS_MOVE_CAPITAL = 100,
	PS_MOVE_CAPITAL_EXTRA = 80,						-- Per 100 country development.
	PS_MOVE_CAPITAL_DISTANCE = 0.005,					-- How many pixels distance per 1 Adm.
	PS_MOVE_CAPITAL_DISTANCE_CAP = 2000,				-- How much this penalty is allowed to cost in Adm.
	...
	PROVOKE_REVOLT_MIN_PROGRESS = 10.0,	-- Minimum revolt progress to use provoke
	UNREST_DECAY = 1.0,
	...
	CORE_LOSE_CULTURE_GROUP = 30,					-- how many years until a core in a country's culture group is lost.
	...
	MAX_NATIONALISM = 80,							-- how much extra nationalism can there be in a province, added with the effect, not by conquering
	...
	YEARS_UNTIL_BROKEN = 1, 						-- _CDEF_YEARS_UNTIL_BROKEN_; Years until rebel held capital results in broken country.
	BASE_HEIR_BIRTH = 120, 							-- _CDEF_BASE_HEIR_BIRTH_
	AGE_OF_ADULTHOOD = 15, 							-- _CDEF_AGE_OF_ADULTHOOD_
	MAX_QUEEN_AGE = 30,								-- You can't get a queen/prince older than this
	MAX_EXTRA_PERSONALITIES = 9,					-- Number of personalities that can be gained except the one you get when turning 15.
	...
	GALLEY_INLAND_SEA_COAST_RATIO = 0.50, 			-- % of ports that need to be inland seas for galleys to be considered important
	...
	REVOLT_SIZE_DEVELOPMENT_MULTIPLIER = 0.15,		-- Multiplied with the province's development
	REVOLT_SIZE_BASE = 1,
	REVOLT_TECH_IMPACT = 0.06, 			-- % each tech increases size of rebels by this percent.
	REVOLT_TECH_MORALE = 0.012,			-- 1% per tech level
	...
	REBEL_ARTILLERY_INCREASE_LEVEL_2_SIZE = 0.3,	-- The increase in artillery as fraction of total troops given to rebels (does not stack with level 1)
	...
	HORDE_RAZE_TECH_POWER_DECREASE = 0.05, -- Per military tech above base level
	HORDE_RAZE_TECH_POWER_DECREASE_MAX = 0.9,
	...
	LEADER_PIPS_MONARCH_SKILL_INFLUENCE = 2.0, -- Influence of leader pips on monarch skills
...
NEconomy = {
	...
	INFLATION_ACTION_REDUCTION = 5,					-- amount per action
	...
	TRADE_PROPAGATE_DIVIDER = 20,
	TRADE_PROPAGATE_THRESHOLD = 2,
	REGAIN_COST_BEFORE_PROGRESS = 0.5,				-- Before what percentage will the full cost be regained
	...
	CARAVAN_POWER_MIN = 2,
	MAX_BUILDING_SLOTS = 20,						-- Maximum number of buildings slots, i.e. max buildings possible.
	COT_BUILDING_SLOTS = 1,							-- Number of slots used by a Center of Trade.
...
NMilitary = {
	...
	ARMY_DRILL_SKILL_MONTHS = 24,					-- The average number of months until you get a skill increase if drilling 100% of forcelimit. Set to 0 to disable.
	...
	BASE_MP_TO_MANPOWER = 0.188,		-- 250 men per manpower
	SIEGE_ATTRITION = 1,
	...
	INFANTRY_BREAKTHROUGH = 0.02,					-- Between 0 and 1
	...
	BACK_LINE_MORALE_DAMAGE_TAKEN_MODIFIER = 0.3,	-- Multiplier for morale damage taken by backrow
	...
	DELIBERATE_RETREAT_MORALE_PENALTY = 0.5,			-- Penalty to morale for units remaining in battle when performing a deliberate retreat with a unit. This value * maximum morale * fraction of army that unit represents is the amount lost.
	...
	RESERVE_DAILY_MORALE_DAMAGE = 0.01,				-- Reserve troops take this fraction of their maximum morale as damage (modified by reserves_organisation)
	...
	MERCENARY_COMPANY_MANPOWER_PER_REGIMENT = 0.9,	-- Manpower reserve factor (multiplied by 1000 per regiment)
...
NAI = {
	...
	DIPLOMATIC_ACTION_CRUSADE_POWERBALANCE_FACTOR = 1000, --AI scoring for calling crusade on power balance threat.
	...
	DIPLOMATIC_ACTION_TAKE_ON_DEBT_BASE_FACTOR = 10, -- AI base scoring for Take on Foreign Debt (needs to be ally or block rival/power balance threat to even apply).
	...
	HRE_FORCE_JOIN_BASE_DESIRE = 1000.0, --Base desire for force join HRE treaty.
	
	HRE_DESIRE_DISMANTLED = -1000,
	HRE_DESIRE_ALREADY_MEMBER = -1000,
	HRE_DESIRE_GOVERNMENT_RANK_LOSS = -20,
	HRE_DESIRE_IN_LINE_TO_SUCCEED = 100,
	HRE_DESIRE_TOO_HOLY = -150,
	HRE_DESIRE_DOESNT_WANT_TO_SUBMIT = -50,
	...
	HRE_DESIRE_WANTS_TO_ALLY_EMPEROR = 100,
	HRE_DESIRE_WANTS_TO_BEFRIEND_EMPEROR = 100,
	...
	BIGSHIP_FRACTION = 0.8,	-- The proportion of big ships in an AI navy of light ships and big ships (for coastal sea countries, this fraction is mostly galleys)
	...
	FORCE_COMPOSITION_CHANGE_TECH_LEVEL = 14, -- Tech level at which AI will double its artillery fraction
	...
	COLONY_BUDGET_FRACTION = 0.8, -- AI will spend a maximum of this amount of monthly ducats for colonies.
	ARMY_BUDGET_FRACTION = 6.0, -- AI will spend a maximum of this fraction of monthly income on army maintenance (based off wartime costs)
	...
	MAX_AI_ADMIRALS_WANTED_WARTIME = 20,
	MAX_AI_ADMIRALS_WANTED_PEACETIME = 20,
	...
	DEVELOPMENT_CAP_BASE = 500,	-- AI will not develop provinces that have more development than this or DEVELOPMENT_CAP_MULT*original development (whichever is bigger)
	DEVELOPMENT_CAP_MULT = 100,

	PEACE_BASE_RELUCTANCE = 1, -- AI base stubbornness to refuse peace (always applied)
	...
	PEACE_HIGH_WAR_EXHAUSTION_THRESHOLD = 5, -- Threshold for when PEACE_HIGH_WAR_EXHAUSTION_FACTOR is applied
	PEACE_HIGH_WAR_EXHAUSTION_FACTOR = 3.0, -- Additional AI willingness to peace based on war exhaustion above the high threshold
	...
	PEACE_ALLY_BASE_RELUCTANCE_MULT = 10.0, -- Multiplies PEACE_BASE_RELUCTANCE for allies in a war
	PEACE_ALLY_WARSCORE_MULT = 1, -- How much extra war enthusiasm from overall warscore allies in a war get
	...
	PEACE_ALLY_WAR_EXHAUSTION_MULT = 2.0, -- Multiplies PEACE_WAR_EXHAUSTION_FACTOR for allies in a war
	...
	PEACE_ACCEPTANCE_NON_BELLIGERENT = 40,	-- We want the AI to peace out war allies faster
	...
	DIPLOMATIC_ACTION_AGITATE_FOR_LIBERTY_ANTAGONIZE_FACTOR = 100, -- AI scoring for agitating for liberty is increased by this if they have an attitude with 'antagonize' desire
	DIPLOMATIC_ACTION_AGITATE_FOR_LIBERTY_RIVAL_FACTOR = 200, -- AI scoring for agitating for liberty is increased by this if they are rivals
	DIPLOMATIC_ACTION_AGITATE_FOR_LIBERTY_DEVELOPMENT_FACTOR = 1, -- AI scoring for agitate for liberty multiplied by development of subject agitated.
	...
	DIPLOMATIC_ACTION_STEAL_MAPS_REGION_SELF_VALUE_MULT = 2, -- AI scoring multiplier for map stealing is increased by this for region's value to self
	...
	DIPLOMATIC_ACTION_SLANDER_MERCHANTS_RIVAL_FACTOR = 100, -- AI scoring for slander merchants is increased by this if they are rivals
	DIPLOMATIC_ACTION_SABOTAGE_RECRUITMENT_ANTAGONIZE_FACTOR = 100, -- AI scoring for sabotage recruitment is increased by this if they have an attitude with 'antagonize' desire
	DIPLOMATIC_ACTION_SABOTAGE_RECRUITMENT_RIVAL_FACTOR = 200, -- AI scoring for sabotage recruitment is increased by this if they are rivals
	DIPLOMATIC_ACTION_CORRUPT_OFFICIALS_ANTAGONIZE_FACTOR = 50, -- AI scoring for slander merchants is increased by this if they have an attitude with 'antagonize' desire
	DIPLOMATIC_ACTION_CORRUPT_OFFICIALS_RIVAL_FACTOR = 100, -- AI scoring for corrupt officials is increased by this if they are rivals
	...
	TRADE_POLICY_PROPAGATE_RELIGION_SCORE = 1000.0,				-- Score for propagate religion trade policy (if selectable)
	...
	WAR_MIN_WARSCORE_TO_JOIN = -50,								-- Starting warscore for the AI to join a call for arms
	...
	BUY_INDULGENCE_BASE_AI_DESIRE = 0.1,						-- AI desire for buy indulgence if curia controller has negative opinion of it, multiplied by budget/cost
	...
	BUY_INDULGENCE_EXCOM_AI_DESIRE = 50,						-- AI desire for buy indulgence if it's excommunicated, multiplied by budget/cost
	APPOINT_CARDINAL_CORRUPTION_THRESHOLD = 2,					-- Upper bound to the corruption the Papal State should have before appoint cardinals in its own land
...
NReligion = {
	...
	MAX_CARDINALS = 132,											-- Max amount of cardinals
	MAX_CARDINALS_PER_COUNTRY = 132,								-- Max cardinals in a single country
	...
	CALL_ECUMENICAL_COUNCIL_TREASURY_CONTRIBUTION = 0.5,	-- Amount of the cost of the Call for Ecumenical Council that goes in the Curia Treasury
	...
	APPOINT_CARDINAL_CORRUPTION = 0.2,						-- Corruption gained by the Papal State when appointing cardinals in its own land
